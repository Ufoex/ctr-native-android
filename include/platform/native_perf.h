...
enum NativePerfBucket
{
	...
	NATIVE_PERF_BUCKET_LEVEL_ANIMATE,
	NATIVE_PERF_BUCKET_LEVEL_BSP,
	NATIVE_PERF_BUCKET_LEVEL_DRAW,
	NATIVE_PERF_BUCKET_LEVEL_SKY,
...
enum NativePerfCounter
{
	...
	NATIVE_PERF_COUNTER_GPU_FRAMEBUFFER_FETCH_SPLITS,
	NATIVE_PERF_COUNTER_GPU_FRAMEBUFFER_FETCH_MERGED_SPLITS,
